...
def showimage():
    ...
    filename=filedialog.askopenfilename(initialdir=os.getcwd(),
                                        title="select Image File",filetypes=(("PNG file","*.png"),("JPG file","*.jpg"),("ALL file","*.txt")))
...
Label(frame,text="Color Finder",font="arial 25 bold",bg="black").place(x=10,y=20)

#color1
colors=Canvas(frame,bg="#fff",width=150,height=256,bd=0)
...
#color2
colors2=Canvas(frame,bg="#fff",width=150,height=256,bd=0)
